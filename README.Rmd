...
The following functions create objects for
...
The `RBATS` is still an experimental `R` package. I am inspired in the great `PyBATS` python
package from  [Isaac Lavine](https://www.linkedin.com/in/isaac-lavine-70495929/) and
